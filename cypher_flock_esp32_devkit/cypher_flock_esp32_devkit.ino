...
static void displayBootScreen() {
  ...
  display.drawFastHLine(8, 16, OLED_W - 16, SSD1306_WHITE);

  // Stylized "scan pulse" mark in the corner, similar in spirit to the PN532 splash.
  display.drawCircle(108, 16, 9, SSD1306_WHITE);
  display.drawCircle(108, 16, 5, SSD1306_WHITE);
  display.drawPixel(108, 16, SSD1306_WHITE);
  display.drawLine(108, 16, 116, 10, SSD1306_WHITE);
  ...
  display.println("DevKit");
  display.setCursor(78, 54);
  display.println("WiFi scan");

  display.fillRect(10, 56, 42, 3, SSD1306_WHITE);
  display.display();
}
