...
#define ESP32_CARDPUTER_ADV 5

#ifndef BOARD_PROFILE
#error "BOARD_PROFILE must be set. Use -DBOARD_PROFILE=ESP32_DEVKIT, -DBOARD_PROFILE=ESP32_S3, -DBOARD_PROFILE=ESP32_CYPHERBOX, -DBOARD_PROFILE=ESP32_WAVESHARE_AMOLED_18, or -DBOARD_PROFILE=ESP32_CARDPUTER_ADV"
#endif
...
#elif BOARD_PROFILE == ESP32_CARDPUTER_ADV
#include "profiles/Cardputer_ADV.h"
#else
...
#ifndef USE_CARDPUTER_DISPLAY
#define USE_CARDPUTER_DISPLAY 0
#endif
